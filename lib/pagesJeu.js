...
var choixPossibleURL = "/api/pages/decision";
var choixAleatoireURL = "/api/pages/decisionAleatoire";
var confirmationURL = "/api/pages/confirmation";
var combatURL = "/api/pages/combat";
...
var pages = [
    ...
    },
    {
        ...
        contenu: [
            {
                text: "Tandis que la lumière du jour décline peu à peu, le blizzard se met à souffler sur la banquise en faisant claquer sans relâche la toile de votre tente. Ce bruit lancinant s'ajoutant à la douleur de vos doigts et de vos orteils vous met les nerfs à vif et vous commencez à souhaiter n'avoir jamais mis les pieds dans cet enfer glacé."
            },
            {
                text: "Puis, au beau milieu de la nuit, le vent déchire le bord de la toile et la force de la rafale disperse vos vivres et votreéquipement. Vous êtes contraint de passer le reste de la nuit à plat ventre, appuyé sur les coudes, vos doigts gelés crispés sur la toile pour l'empêcher de s'envoler."
            }
        ],
        decision: choixPossibleURL
    },
    ...
    },
    {
        ...
        contenu: [
            {
                text: "Pendant trois jours et trois nuits, vous avancez à grand-peine surle glacier au tracé sinueux. Les chutes, les bleus, les tibias écorchés, les crevasses, les blocs de glace coupants comme des rasoirs et le vent mordant qui souffle sans cesse se conjuguentpour épuiser vos forces. Vous avez cependant la chance d'échapper à un blizzard et vous parvenez enfin, après unemarche harassante, à atteindre l'abri du mont des Brumes aupied duquel vous décidez d'établir votre campement. Cette immense montagne de près de 4 000 mètres d'altitude a la formed'un gigantesque aileron de requin. Lorsque les vents d'ouest soufflent à son sommet, ils entraînent de longs panaches de brume à travers le glacier de Viad ; c'est cet étrange phénomène qui a donné son nom à la montagne. "
            },
            {
                text: "Vous trouvez bientôt l'endroit idéal pour dresser votre tente, sur un sol couvert derocaille. En quelques instants, tout est installé et vous voilà à nouveau dans votre abri de toile. Avant de vous endormir, vous sortez quelques minutes pour satisfaire une exigence de la nature; c'est alors que, par un pur hasard, vous apercevez une faible lueur qui filtre à travers une fissure de la paroi rocheuse, au-dessus de vous."
            }
        ],
        decision: choixPossibleURL
    },
    ...
    },
    {
        ...
        contenu: [
            {
                text: "Le lendemain d'épais nuages de neige se sont amoncelés au-dessus de la banquise de Liouk et un faible vent s'est levé. A mesure que vous approchez du bord du glacier de Viad, le terrain devient plus accidenté. Des blocs de glace se dressent çà et là, formant des obstacles difficiles à franchir."
            },
            {
                text: "Vous êtes contraint de descendre des traîneaux et de les manœuvrer à la main parmi toutes ces aspérités pour pouvoir atteindre les pentes plus lisses du lointain glacier. Vous avez parcouru environ 800 mètres lorsque vous apercevez soudain devant vous une grande crevasse."
            }
        ],
        decision: choixPossibleURL
    },
